...
GRAPHES_TO_PLOT = ["P-V 40V_1#1"]
#, "P-V 4V_2#1", "IV 3V_1#1", "PUND 5V_1#1", "CV 3V_1#1"
GRAPH_VOLTAGES = ["10"] # currently not used just enter the complet graph name above
